...
SaveManager:SetFolder("twvz/afkarise")
...
player.OnTeleport:Connect(function(State)
    if _G.AriseSettings.Toggles.AutoReinject and not TeleportCheck and queueteleport then
        TeleportCheck = true
        queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ZhangJunZ84/twvz/refs/heads/main/ariseafkwebhook.lua'))()")
        Fluent:Notify({
